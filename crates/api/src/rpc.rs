...
api_methods! {
    ...
    METHOD_ENVIRONMENTS_PROVIDERS_TARGETS_LIST => list_environment_provider_targets(EnvironmentProviderTargetListParams) -> EnvironmentProviderTargetListResponse,
...
pub const NOTIFICATION_METHODS: &[&str] = &[
    ...
    NOTIFY_SESSION_ITEMS_COMPLETED,
    NOTIFY_ERROR,
];
