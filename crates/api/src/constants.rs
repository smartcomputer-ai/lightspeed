...
pub const METHOD_ENVIRONMENTS_ENROLLMENTS_CREATE: &str = "environments/enrollments/create";
pub const METHOD_ENVIRONMENTS_ENROLLMENTS_READ: &str = "environments/enrollments/read";
pub const METHOD_ENVIRONMENTS_ENROLLMENTS_REVOKE: &str = "environments/enrollments/revoke";
