...
use api::{
    ...
    METHOD_SESSION_ENVIRONMENTS_READ, METHOD_SESSION_EVENTS_READ, METHOD_SESSION_MCP_LINK,
    ...
    SessionEventsReadParams, SessionEventsReadResponse, SessionMcpLinkParams,
