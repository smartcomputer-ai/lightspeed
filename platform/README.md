...
stream first. Their pending opacity eases to full over 100 ms; reduced-motion
...
New inputs, activity boxes, and assistant messages enter with a 180 ms fade and
