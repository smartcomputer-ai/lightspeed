...
| Variable | Requirement/default | Purpose |
| --- | --- | --- |
| `LIGHTSPEED_PLATFORM_API_KEY` | Unset | Canonical Platform service bearer key for the authenticated runtime. Full development bootstraps one explicitly when omitted. |
