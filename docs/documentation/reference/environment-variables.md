...
| `LIGHTSPEED_PLATFORM_ADMIN_PRINCIPAL_ID` | Unset | Existing active core user with DeploymentAdmin to bind to the first Platform login. Required with bootstrap email/password; the full development launcher provisions it. |
